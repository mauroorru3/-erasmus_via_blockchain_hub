...
type ChainInfo struct {
	...
	StartFlag             bool   `protobuf:"varint,3,opt,name=startFlag,proto3" json:"startFlag,omitempty"`
}
...
func (m *ChainInfo) GetStartFlag() bool {
	if m != nil {
		return m.StartFlag
	}
	return false
...
var fileDescriptor_f6a228684842ccbf = []byte{
	...
	0x17, 0x62, 0xcf, 0x28, 0x4d, 0xd2, 0xcb, 0x28, 0x4d, 0x52, 0xaa, 0xe6, 0xe2, 0x74, 0x06, 0x49,
	...
	0x21, 0x19, 0x2e, 0xce, 0xe2, 0x92, 0xc4, 0xa2, 0x12, 0xb7, 0x9c, 0xc4, 0x74, 0x09, 0x66, 0x05,
	0x46, 0x0d, 0x8e, 0x20, 0x84, 0x80, 0x93, 0xe6, 0x89, 0x47, 0x72, 0x8c, 0x17, 0x1e, 0xc9, 0x31,
	0x3e, 0x78, 0x24, 0xc7, 0x38, 0xe1, 0xb1, 0x1c, 0xc3, 0x85, 0xc7, 0x72, 0x0c, 0x37, 0x1e, 0xcb,
	0x31, 0x44, 0xf1, 0x83, 0x5c, 0x5d, 0xa1, 0x0f, 0x22, 0x4b, 0x2a, 0x0b, 0x52, 0x8b, 0x93, 0xd8,
	0xc0, 0xee, 0x36, 0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0xc5, 0xf9, 0xb0, 0x25, 0xcf, 0x00, 0x00,
	0x00,
}
...
func (m *ChainInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field StartFlag", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
